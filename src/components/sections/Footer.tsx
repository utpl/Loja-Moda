...
export const Footer = () => {
  return (
    <footer className="relative bg-linear-to-br from-slate-50 via-white to-indigo-50 border-t border-gray-200">
      <div className="2xl:mx-auto 2xl:container px-4 sm:px-6 xl:px-20 2xl:px-0 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 text-base mb-6 max-w-md leading-relaxed">
              Donde el estilo cobra vida. Prueba virtualmente tu ropa antes de comprar con nuestra tecnología de IA avanzada.
            </p>
            ...
            <div className="flex space-x-3">
              <a 
                href="#" 
                className="group w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110 border border-gray-200"
                aria-label="Twitter"
              >
          ...
          {/* Navegación */}
          <div>
            <h3 className="text-gray-900 font-bold text-lg mb-4">Navegación</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors duration-300 flex items-center group">
                  <span className="w-0 h-0.5 bg-indigo-600 group-hover:w-4 transition-all duration-300 mr-0 group-hover:mr-2"></span>
                  Acerca de nosotros
                </a>
              </li>
              <li>
      ...
      <div className="absolute bottom-0 right-0 w-64 h-64 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
      <div className="absolute top-0 left-0 w-64 h-64 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
    </footer>
  );
};